...
<head>
    ...
    <meta charset="utf-8" />
    <title>Register - AliCryptoFx</title>
        ...
        <div class="container-fluid user-auth">
			...
			<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
					...
					<div>
						...
						<!-- Form Starts -->
							...
							<!-- Input Field Ends -->
                                                        <!-- Input Field Starts -->
							<div class="form-group">
								<input class="form-control" name="phone" id="phone" placeholder="Phone number (including country dialing code)" type="text" required>
				...
				<!-- Copyright Text Starts -->
                                <p class="text-center">&COPY; 2021 AliCryptoFx</p>
                                <!-- Copyright Text Ends -->
			</div>
		</div>
        <!-- Template JS Files -->
